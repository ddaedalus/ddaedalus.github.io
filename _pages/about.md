...
Currently, I am a Research Assistant at University of Pireaus (UPRC), working on Explainable Reinforcement Learning (XRL). My research focuses on how we can utilize  Decision Trees for mimicing the learned policy of an RL agent towards inferring the state feature importance. Also, I am an M.Sc. student in Data Science and Machine Learning in National Technical University of Athens (NTUA).
...
### 2020
* 21/11. **Presentation**: I am giving a virtual oral presention of our work *"A Personalized Artificial-Intelligence-enabled Method for Efficient Research in Ethnopharmacology"* at FOSSCOMM 2020! [[video]](https://www.youtube.com/watch?v=fKs8cLw45IM&t=1006s&ab_channel=EvangelosAxiotis)
